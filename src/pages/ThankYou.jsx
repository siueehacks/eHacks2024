    ...
    <div className="Page">
      ...
      <div className="ContentBox">
        <Flex direction="column" justify="center" gap="2vh" h="100vh">
          ...
          <Text><ChakraLink href="https://discord.gg/GhAMupx3fS" target="_blank" textDecoration="underline">Click to join</ChakraLink> the event Discord server so you don't miss any announcements!</Text>
